            ...
            <div className="flex flex-col md:flex-row gap-16 mt-4">
                ...
                <div className="flex gap-3">
                    <div className="flex flex-col gap-3">
                        {product?.image?.map((image, index) => (
                            <div className="border max-w-24 border-gray-500/30 rounded overflow-hidden cursor-pointer" key={index} onClick={() => setThumbnail(image)}>
                                <img src={image} alt="" />
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="border border-gray-500/30 max-w-100 rounded overflow-hidden">
                        <img src={thumbnail} alt="selected product image" />
                    </div>
                </div>
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className='mt-6'>
                        ...
                        <p class="text-2xl font-medium">MRP: {currency}{product.offerPrice}</p>
