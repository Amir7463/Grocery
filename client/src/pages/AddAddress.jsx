...
const AddAddress = () => {
  ...
  const onSubmitHandler = async (e) => {
    e.preventDefault();
    try {
      const res = await axios.post("/api/address/add", {
      ...
      // Save last address for cart page (guest & logged-in)
      localStorage.setItem("lastAddress", JSON.stringify(res.data.address));
      ...
      <div className='flex flex-col-reverse md:flex-row justify-between mt-10'>
        <div className="flex-1 max-w-md">
          <form onSubmit={onSubmitHandler} className='space-y-3 mt-6 text-sm'>
            ...
            <div className="flex gap-3">
              <InputField type="text" placeholder="Zip code" name="zipcode" handleChange={handleChange} address={address} />
