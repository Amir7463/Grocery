    ...
    return (
        <div className="w-full relative">
            ...
            <div className="flex items-center mt-6 font-medium">
                ...
                <img src={assets.white_arrow_icon} alt="Shop Now Arrow" className="md:hidden transition group-focus:translate-x-1" />
                </Link>

                <Link to={"/products"} className="group hidden md:flex items-center gap-2 px-9 py-3 cursor-pointer">Explore deals
                <img src={assets.black_arrow_icon} alt="Shop Now Arrow" className="transition group-hover:translate-x-1" />
                </Link>
            </div>
            </div>
        </div>
